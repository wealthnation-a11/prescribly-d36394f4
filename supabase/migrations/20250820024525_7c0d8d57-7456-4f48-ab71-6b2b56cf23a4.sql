-- Create companion questions table
CREATE TABLE public.companion_questions (
...
-- Create user daily check-ins table
...
-- Insert the 15 preloaded questions
...
('nutrition', 'Did you eat a balanced breakfast today?'),
...
-- Create function to get daily questions for user
...
AS $function$
BEGIN
  -- Get 3-5 random questions that user hasn't answered today
  RETURN QUERY
  ...
  ORDER BY RANDOM()
  LIMIT 4; -- Return 4 questions per day
END;
$function$;